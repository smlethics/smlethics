...
A practical open-source reference implementation of a **Model Context Protocol server** designed to expose configurable external APIs as MCP tools.

Built with **Java 21, Spring Boot, Spring AI and Streamable HTTP**, with secure server-side secret handling, an allowlisted API catalog, tests, GitHub Actions and Windows Service support through WinSW.

**Repository:** [mcp-universal-api-windows-service](https://github.com/smlethics/mcp-universal-api-windows-service)
